...
set Libero_project_name_CFG1 PF_Splash_Kit_ES_MIV_RV32_CFG1_BaseDesign

set project_folder_name_CFG2 MIV_CFG2_BD
set project_dir_CFG2 "./$project_folder_name_CFG2"
set Libero_project_name_CFG2 PF_Splash_Kit_ES_MIV_RV32_CFG2_BaseDesign

set project_folder_name_CFG3 MIV_CFG3_BD
set project_dir_CFG3 "./$project_folder_name_CFG3"
set Libero_project_name_CFG3 PF_Splash_Kit_ES_MIV_RV32_CFG3_BaseDesign
...
{
	puts "\n---------------------------------------------------------------------------------------------------------"
	puts "Creating a new project for the 'PF_Splash_Kit_ES' board."
	puts "--------------------------------------------------------------------------------------------------------- \n"
}
...
{
	puts "\n---------------------------------------------------------------------------------------------------------"
	puts "Error: A project exists for the 'PF_Splash_Kit_ES' with this configuration."
	puts "--------------------------------------------------------------------------------------------------------- \n"
}
...
if {"$config" == "CFG1"} then {
	if {[file exists $project_dir_CFG1] == 1} then {
		...
		new_project -location $project_dir_CFG1 -name $Libero_project_name_CFG1 -project_description {} -block_mode 0 -standalone_peripheral_initialization 0 -instantiate_in_smartdesign 1 -ondemand_build_dh 1 -hdl {VERILOG} -family {PolarFire} -die {MPF300TS_ES} -package {FCG484} -speed {-1} -die_voltage {1.0} -part_range {EXT} -adv_options {IO_DEFT_STD:LVCMOS 1.8V} -adv_options {RESTRICTPROBEPINS:1} -adv_options {RESTRICTSPIPINS:0} -adv_options {SYSTEM_CONTROLLER_SUSPEND_MODE:0} -adv_options {TEMPR:EXT} -adv_options {VCCI_1.2_VOLTR:EXT} -adv_options {VCCI_1.5_VOLTR:EXT} -adv_options {VCCI_1.8_VOLTR:EXT} -adv_options {VCCI_2.5_VOLTR:EXT} -adv_options {VCCI_3.3_VOLTR:EXT} -adv_options {VOLTR:EXT} 
		download_required_direct_cores
		source ./import/components/IMC_CFG1/import_component_and_constraints_pf_splash_kit_rv32imc_cfg1.tcl
		save_project
        base_design_built
	}
	...
	if {[file exists $project_dir_CFG2] == 1} then {
		...
		create_new_project_label
		new_project -location $project_dir_CFG2 -name $Libero_project_name_CFG2 -project_description {} -block_mode 0 -standalone_peripheral_initialization 0 -instantiate_in_smartdesign 1 -ondemand_build_dh 1 -hdl {VERILOG} -family {PolarFire} -die {MPF300TS_ES} -package {FCG484} -speed {-1} -die_voltage {1.0} -part_range {EXT} -adv_options {IO_DEFT_STD:LVCMOS 1.8V} -adv_options {RESTRICTPROBEPINS:1} -adv_options {RESTRICTSPIPINS:0} -adv_options {SYSTEM_CONTROLLER_SUSPEND_MODE:0} -adv_options {TEMPR:EXT} -adv_options {VCCI_1.2_VOLTR:EXT} -adv_options {VCCI_1.5_VOLTR:EXT} -adv_options {VCCI_1.8_VOLTR:EXT} -adv_options {VCCI_2.5_VOLTR:EXT} -adv_options {VCCI_3.3_VOLTR:EXT} -adv_options {VOLTR:EXT}
		download_required_direct_cores
		source ./import/components/IMC_CFG2/import_component_and_constraints_pf_splash_kit_rv32imc_cfg2.tcl
		save_project
        base_design_built
	}
	...
	if {[file exists $project_dir_CFG3] == 1} then {
		...
		create_new_project_label
		new_project -location $project_dir_CFG3 -name $Libero_project_name_CFG3 -project_description {} -block_mode 0 -standalone_peripheral_initialization 0 -instantiate_in_smartdesign 1 -ondemand_build_dh 1 -hdl {VERILOG} -family {PolarFire} -die {MPF300TS_ES} -package {FCG484} -speed {-1} -die_voltage {1.0} -part_range {EXT} -adv_options {IO_DEFT_STD:LVCMOS 1.8V} -adv_options {RESTRICTPROBEPINS:1} -adv_options {RESTRICTSPIPINS:0} -adv_options {SYSTEM_CONTROLLER_SUSPEND_MODE:0} -adv_options {TEMPR:EXT} -adv_options {VCCI_1.2_VOLTR:EXT} -adv_options {VCCI_1.5_VOLTR:EXT} -adv_options {VCCI_1.8_VOLTR:EXT} -adv_options {VCCI_2.5_VOLTR:EXT} -adv_options {VCCI_3.3_VOLTR:EXT} -adv_options {VOLTR:EXT} 
		download_required_direct_cores
		source ./import/components/IMC_CFG3/import_component_and_constraints_pf_splash_kit_rv32imc_cfg3.tcl
		save_project
        base_design_built
	}
} elseif {"$config" != ""} then {
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$config" == "CFG1"} then {
		export_prog_job \
			-job_file_name {PF_Splash_Kit_ES_MIV_RV32_CFG1_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {PF_Splash_Kit_ES_MIV_RV32_CFG2_BaseDesign} \
		...
		save_project
			...
			export_prog_job \
			-job_file_name {PF_Splash_Kit_ES_MIV_RV32_CFG3_BaseDesign} \
