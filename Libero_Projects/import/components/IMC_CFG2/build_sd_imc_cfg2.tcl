...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreRESET_PF_0:CLK" "CoreTimer_0:PCLK" "CoreTimer_1:PCLK" "MIV_ESS_0:PCLK" "MIV_RV32_CFG2_0:CLK" "PF_CCC_0:OUT0_FABCLK_0" "PF_SRAM_AXI4_0:ACLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CoreRESET_PF_0:FABRIC_RESET_N" "CoreTimer_0:PRESETn" "CoreTimer_1:PRESETn" "MIV_ESS_0:PRESETN" "MIV_RV32_CFG2_0:RESETN" "PF_SRAM_AXI4_0:ARESETN" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIV_RV32_CFG2_0:AXI4_M_SLV" "PF_SRAM_AXI4_0:AXI4_Slave" }
