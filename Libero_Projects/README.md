...
This folder contains Tcl scripts that build Libero SoC v2021.3 design projects for the PolarFire FPGA Splash-Kit. These scripts are executed in Libero SoC to generate the sample designs. All cores boot from memory at 0x8000_0000.


#### PF_Splash_Kit_ES_MIV_RV32IMA_BaseDesign (or ES equivalent)
...
#### PF_Splash_Kit_ES_MIV_RV32IMAF_BaseDesign (or ES equivalent)
...
#### PF_Splash_Kit_ES_MIV_RV32_BaseDesign (or ES equivalent)
