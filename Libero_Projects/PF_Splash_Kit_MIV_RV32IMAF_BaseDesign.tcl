...
proc create_new_project_label { } {
	puts "\n------------------------------------------------------------------------------- \
		  \r\nCreating a new project for the 'PF_Splash_Kit' board. \
		  \r\n------------------------------------------------------------------------------- \n"
}

proc project_exists { } {
	puts "\n------------------------------------------------------------------------------- \
		  \r\nError: A project exists for the 'PF_Splash_Kit' with this configuration. \
		  \r\n------------------------------------------------------------------------------- \n"
}
...
puts "hw_platform: $hw_platform"
puts "soft_cpu: $soft_cpu"
puts "sd_reference: $sd_reference"
puts "project_folder_name: $project_folder_name"
