...
set Libero_project_name_CFG1 PF_Splash_Kit_MIV_RV32_CFG1_BaseDesign

set project_folder_name_CFG2 MIV_CFG2_BD
set project_dir_CFG2 "./$project_folder_name_CFG2"
set Libero_project_name_CFG2 PF_Splash_Kit_MIV_RV32_CFG2_BaseDesign

set project_folder_name_CFG3 MIV_CFG3_BD
set project_dir_CFG3 "./$project_folder_name_CFG3"
set Libero_project_name_CFG3 PF_Splash_Kit_MIV_RV32_CFG3_BaseDesign
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$config" == "CFG1"} then {
		export_prog_job \
			-job_file_name {PF_Splash_Kit_MIV_RV32_CFG1_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {PF_Splash_Kit_MIV_RV32_CFG2_BaseDesign} \
		...
		save_project
			...
			export_prog_job \
			-job_file_name {PF_Splash_Kit_MIV_RV32_CFG3_BaseDesign} \
